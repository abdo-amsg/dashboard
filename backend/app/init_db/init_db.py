        ...
        if dashboard_db.query(DashboardModels.KPI).count() == 0:
            kpis = [
                ...
                DashboardModels.KPI(
                    ...
                    category='Detect',
                    rpc_function='get_average_detection_rule_performance'
                ),
                DashboardModels.KPI(
                    ...
                    data_source='SIEM Logs, Threat Intelligence, Incident Reports, Malware Detection Logs, Firewall logs',
                    category='Detect',
                    rpc_function='get_detection_rule_performance'
                ),
                DashboardModels.KPI(
                ...
                DashboardModels.KPI(
                    ...
                    data_source='Vulnerability Scanner',
                    category='Identify',
                    rpc_function='get_average_cvss_score_trends'
                ),
                DashboardModels.KPI(
                    ...
                    threshold=10,
                    frequency='Monthly',
                    formula='Count of vulnerabilities by Vulnerabilitie',
                    reporting_format='List',
                    data_source='Vulnerability Scanner',
                    category='Identify',
