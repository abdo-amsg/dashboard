...
const CISODashboard = ({ returnToSelector }) => {
  ...
  const renderKPICard = (title, value, IconComponent, trend, color = colors.primary, description = '') => (
    <div className="bg-white rounded-xl p-6 border border-gray-200 hover:border-purple-300 shadow-lg hover:shadow-xl transition-all  hover:transform hover:scale-105 group relative overflow-hidden">
      {/* Background gradient effect */}
      <div className="absolute inset-0 bg-gradient-to-br from-transparent via-purple-50/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity "></div>
  ...
  const renderChart = (type, data, title, reportType) => {
    ...
    const ChartContainer = ({ children }) => (
      <div className="bg-gradient-to-br from-white via-gray-50 to-purple-50 rounded-2xl p-8 border border-gray-200 shadow-xl hover:shadow-2xl transition-all  hover:transform hover:scale-[1.02] relative overflow-hidden group">
        ...
        <div className="flex items-center justify-between mb-6 relative z-10">
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              className="p-3 text-gray-400 hover:text-purple-600 hover:bg-purple-50 rounded-xl transition-all  hover:scale-110"
            >
              ...
              <div className="text-center">
                ...
                <div className="flex gap-2 justify-center">
                  <button
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white rounded-lg transition-all  shadow-md hover:shadow-lg transform hover:scale-105"
                  >
