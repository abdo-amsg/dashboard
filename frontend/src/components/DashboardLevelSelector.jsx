          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
            {dashboardLevels.map((level) => {
              ...
              return (
                <div
                  key={level.id}
                  className={`relative bg-white rounded-2xl p-8 border border-gray-200 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105 group cursor-pointer ${
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    {/* Action Button */}
                    <button
                      className={`w-full py-4 px-6 bg-gradient-to-r ${level.color} text-white font-semibold rounded-xl hover:shadow-lg transition-all duration-300 transform group-hover:scale-105 flex items-center justify-center ${
                        level.comingSoon ? 'cursor-not-allowed opacity-50' : 'hover:shadow-xl'
                      }`}
